...
$_lang['babel.babellinks.restrictToGroup'] = 'Beschränke die Kontexte in der Snippet-Ausgabe auf die Gruppe mit dem aktuellen Kontext. Siehe Systemeinstellung `babel.contextKeys` zur Definition von Kontext-Schlüssel-Gruppen.';
$_lang['babel.babellinks.showCurrent'] = 'Gibt an, ob ein Link zu einer Übersetzung der aktuellen Sprache angezeigt werden soll.';
$_lang['babel.babellinks.showUnpublished'] = 'Gibt an, ob unveröffentlichte Übersetzungen angezeigt werden sollen.';
$_lang['babel.babellinks.sortby'] = 'Kontextfeld zum Sortieren der Ergebnisse.';
$_lang['babel.babellinks.sortdir'] = 'Die Richtung, in die sortiert werden soll.';
