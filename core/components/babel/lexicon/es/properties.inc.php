...
$_lang['babel.babellinks.sortdir'] = 'La dirección a ordenar.';
$_lang['babel.babellinks.toArray'] = 'Marca si se debe volcar la salida como una matriz en su lugar.';
$_lang['babel.babellinks.toPlaceholder'] = 'Marca si se debe volcar la salida en el nombre del marcador de posición dado.';
$_lang['babel.babellinks.tpl'] = 'Chunk para mostrar un enlace de idioma.';
$_lang['babel.babellinks.wrapperTpl'] = 'Chunk para envolver todos los enlaces de idioma. El marcador de posición para todos los enlaces es [[+babelLinks]].';
$_lang['babel.babeltranslation.contextKey'] = 'Clave del contexto en el que debe determinarse el recurso traducido.';
$_lang['babel.babeltranslation.cultureKey'] = 'Clave de la cultura en la que debe determinarse el recurso traducido. Sólo se utiliza en caso de que no se haya especificado contextKey. Si ambos omitieron el fragmento el cultureKey establecido actualmente.';
