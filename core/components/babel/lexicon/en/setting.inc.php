...
$_lang['setting_babel.displayChunk'] = 'Button Chunk';
$_lang['setting_babel.displayChunk_desc'] = 'Name of a chunk that is used for the text in the Babel button in each context.';
$_lang['setting_babel.displayText'] = 'Button Text';
